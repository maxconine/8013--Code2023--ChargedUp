...
//     private Arm() {
//         mArm = TalonFXFactory.createDefaultTalon(Ports.ARM_ID);
...
//     //If arm is moving less than 0.5 m/s and arm current is greater than constant stator current limit
...
//         SmartDashboard.putNumber("Climber Demand", mPeriodicIO.arm_demand);
//         SmartDashboard.putNumber("Climber Voltage ", mPeriodicIO.arm_voltage);
//         SmartDashboard.putNumber("Climber Current ", mPeriodicIO.arm_stator_current);
