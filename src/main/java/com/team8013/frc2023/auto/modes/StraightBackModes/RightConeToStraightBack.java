...
public class RightConeToStraightBack extends AutoModeBase {
        ...
        String path_a = "paths/RightStraightOutBlue.path";

        // trajectories
        SwerveTrajectoryAction rightStraightOutBlue;

        public RightConeToStraightBack() {
        ...
        protected void routine() throws AutoModeEndedException {
                ...
                runAction(new LambdaAction(() -> mSwerve.resetOdometry(rightStraightOutBlue.getInitialPose())));
                ...
                runAction(rightStraightOutBlue);
        ...
        public Pose2d getStartingPose() {
                return rightStraightOutBlue.getInitialPose();
        }
}
