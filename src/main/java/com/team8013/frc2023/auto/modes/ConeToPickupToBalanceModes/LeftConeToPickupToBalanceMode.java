...
public class LeftConeToPickupToBalanceMode extends AutoModeBase {
        ...
        String path_a = "paths/LeftConeToPickupToBalanceBlue_A.path";
        String path_b = "paths/LeftConeToPickupToBalanceBlue_B.path";

        // trajectories
        SwerveTrajectoryAction farLeftTopNodeToPickup_a;
        SwerveTrajectoryAction leftPickupToBalance_b;

        public LeftConeToPickupToBalanceMode() {
                ...
                Trajectory traj_path_a = AutoTrajectoryReader.generateTrajectoryFromFile(path_a,
                                ...
                                farLeftTopNodeToPickup_a = new SwerveTrajectoryAction(traj_path_a,
                ...
                Trajectory traj_path_b = AutoTrajectoryReader.generateTrajectoryFromFile(path_b,
                                Constants.AutoConstants.defaultSpeedConfig);
                                leftPickupToBalance_b = new SwerveTrajectoryAction(traj_path_b,
                                mSwerve::getPose, Constants.SwerveConstants.swerveKinematics,
                                new PIDController(Constants.AutoConstants.kPXController, 0, 0),
                                new PIDController(Constants.AutoConstants.kPYController, 0, 0),
                                thetaController,
        ...
        protected void routine() throws AutoModeEndedException {
                ...
                runAction(new LambdaAction(() -> mSwerve.resetOdometry(farLeftTopNodeToPickup_a.getInitialPose())));
                ...
                runAction(new SeriesAction(List.of(farLeftTopNodeToPickup_a,
                ...
                runAction(leftPickupToBalance_b);
        ...
        public Pose2d getStartingPose() {
                return farLeftTopNodeToPickup_a.getInitialPose();
        }
}
