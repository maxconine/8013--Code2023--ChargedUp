...
public class MidConeStraightToBalanceNoTaxi extends AutoModeBase {
    ...
    String path_a = "paths/MidConeStraightToBalanceNoTaxi_A.path";

    // trajectories
    SwerveTrajectoryAction midConeStraightToBalanceBlue;

    public MidConeStraightToBalanceNoTaxi() {
